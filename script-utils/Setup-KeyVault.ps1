...
switch($PSCmdlet.ParameterSetName)
{
    "GenerateCertificate"
    {
        ...
        $x509Cert = New-SelfSignedCertificateEx -NotBefore $NotBefore -NotAfter $NotAfter -Subject $Subject -Path $CertStoreLocation -Provider "Microsoft Strong Cryptographic Provider"
